...
class RackerStacker extends s {
    constructor() {
        super(...arguments);
        this._urlRoot = "/local/racker-stacker";
        this._pixelsPerU = 40.0;
        this._defaultRackHeight = 48;
    ...
    async requestRackConfig() {
        ...
        if (!resp.ok) {
            ...
            this._config = parse(await resp.text());
            this.initRackConfig();
        }
    ...
    initRackConfig() {
        var _a, _b;
        this._rackU = ((_a = this._config) === null || _a === void 0 ? void 0 : _a.rack_height) ? (_b = this._config) === null || _b === void 0 ? void 0 : _b.rack_height : this._defaultRackHeight;
    }
    async requestModel(model) {
        ...
        let data = parse(await resp.text());
    ...
    equipmentTemplate(eq) {
        ...
        const flip = ((_b = this._rack) === null || _b === void 0 ? void 0 : _b.flip) ? this._rack.flip : false;
        if (flip) {
            if (facing == "front")
                facing = "rear";
            else
...
__decorate([
    n$1()
], RackerStacker.prototype, "_config", void 0);
__decorate([
    n$1()
], RackerStacker.prototype, "_rack", void 0);
__decorate([
    n$1()
], RackerStacker.prototype, "_hass", void 0);
__decorate([
    n$1()
